...
/**
 * Servlet implementation class ViewTurfcontroller
 */
@WebServlet("/ViewTurfcontroller")
public class ViewTurfcontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewTurfcontroller() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List <AddTurf>list=turf_dao.Viewturf();
		out.print("<table border='1px solid black'; width='100%'>");
		out.print("<tr> <th> ID </th> <th> GROUND NAME </th> <th> GROUND EMAIL </th> <th> GROUND CAPACITY</th>"
				+ "<th> GROUND ADDRESS </th>  </tr>");
		for(AddTurf ad:list)
